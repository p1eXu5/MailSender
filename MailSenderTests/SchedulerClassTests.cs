...
namespace MailSender.Tests
{
    ...
    public class SchedulerClassTests
    {
        ...
        public void TimeTick_Dictionary_correct()
        {
            ...
            if (sc.DatesEmailTexts.Keys.First().ToShortTimeString() == dt1.ToShortTimeString()) {
            ...
            if (sc.DatesEmailTexts.Keys.First().ToShortTimeString() == dt2.ToShortTimeString()) {
            ...
            if (sc.DatesEmailTexts.Keys.First().ToShortTimeString() == dt3.ToShortTimeString()) {
